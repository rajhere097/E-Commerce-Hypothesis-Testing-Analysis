...
One-Sample T-Test	Is average delivery time different from the industry benchmark?
Two-Sample T-Test	Do female customers spend more than male customers?
ANOVA	Are order values different across cities?
...
📌 Business Impact:
This can be used as a competitive advantage in marketing campaigns.
...
📌 Business Impact:
Targeted promotions for female shoppers could increase revenue.
...
📌 Business Impact:
Improving mobile checkout experience could significantly increase sales.
...
📌 Business Impact:
Rolling out the new design platform-wide can increase total orders.
...
Implement the orange checkout button across the platform
